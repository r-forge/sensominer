...
plot.fahst(x,choix="ind", axes = c(1, 2), xlim = NULL, ylim = NULL, invisible = NULL,
    col.ind = "blue", col.var = "red", lab.ind=TRUE,lab.var=TRUE, lab.lev=TRUE,
    cex = 1,lab.grpe = TRUE, title = NULL, habillage = "none", habillage.lev = "none",
